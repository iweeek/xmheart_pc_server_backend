...
public interface XPWRoleMapper {
     ...
     * @mbg.generated  Sat Jan 06 08:14:22 CST 2018
     */
    @Insert({ "insert into xpw_role (name, priv_ids, ", "is_available)",
            "values (#{name,jdbcType=VARCHAR}, #{privIds,jdbcType=VARCHAR}, ", "#{isAvailable,jdbcType=BIT})" })
     ...
     * @mbg.generated  Sat Jan 06 08:14:22 CST 2018
     */
    @Select({ "select", "id, name, priv_ids, is_available", "from xpw_role", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update xpw_role", "set name = #{name,jdbcType=VARCHAR},", "priv_ids = #{privIds,jdbcType=VARCHAR},",
            "is_available = #{isAvailable,jdbcType=BIT}", "where id = #{id,jdbcType=BIGINT}" })
