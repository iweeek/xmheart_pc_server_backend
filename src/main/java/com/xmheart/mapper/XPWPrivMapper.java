...
public interface XPWPrivMapper {
     ...
     * @mbg.generated  Wed Jan 03 17:06:47 CST 2018
     */
    @Insert({ "insert into xpw_priv (table_name, column_id, ", "name)",
            "values (#{tableName,jdbcType=VARCHAR}, #{columnId,jdbcType=BIGINT}, ", "#{name,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Wed Jan 03 17:06:47 CST 2018
     */
    @Select({ "select", "id, table_name, column_id, name", "from xpw_priv", "where id = #{id,jdbcType=BIGINT}" })
