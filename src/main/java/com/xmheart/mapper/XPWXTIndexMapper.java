...
public interface XPWXTIndexMapper {
	 ...
	 * @mbg.generated  Fri Mar 09 11:20:39 CST 2018
	 */
	@Insert({ "insert into xpw_xtindex (title, content, ", "banner_image_1_url, banner_image_1_action_url, ",
			"banner_image_2_url, banner_image_2_action_url, ", "banner_image_3_url, banner_image_3_action_url)",
			"values (#{title,jdbcType=VARCHAR}, #{content,jdbcType=VARCHAR}, ",
			"#{bannerImage1Url,jdbcType=VARCHAR}, #{bannerImage1ActionUrl,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated  Fri Mar 09 11:20:39 CST 2018
	 */
	@Select({ "select", "id, title, content, banner_image_1_url, banner_image_1_action_url, banner_image_2_url, ",
			"banner_image_2_action_url, banner_image_3_url, banner_image_3_action_url", "from xpw_xtindex",
	 ...
	 * @mbg.generated  Fri Mar 09 11:20:39 CST 2018
	 */
	@Update({ "update xpw_xtindex", "set title = #{title,jdbcType=VARCHAR},", "content = #{content,jdbcType=VARCHAR},",
