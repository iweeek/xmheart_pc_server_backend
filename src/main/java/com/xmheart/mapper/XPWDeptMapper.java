...
public interface XPWDeptMapper {
	 ...
	 * @mbg.generated  Sun Mar 11 22:24:33 CST 2018
	 */
	@Insert({ "insert into xpw_dept (his_id, name, ", "image_url, img_url, ", "url, brief, dept_doctor_url, ",
			"out_service, admin_expert_id, ", "is_displayed, name_en, ", "intro)",
			"values (#{hisId,jdbcType=INTEGER}, #{name,jdbcType=VARCHAR}, ",
			"#{imageUrl,jdbcType=VARCHAR}, #{imgUrl,jdbcType=VARCHAR}, ",
			...
			"#{isDisplayed,jdbcType=TINYINT}, #{nameEn,jdbcType=VARCHAR}, ", "#{intro,jdbcType=LONGVARCHAR})" })
	 ...
	 * @mbg.generated  Sun Mar 11 22:24:33 CST 2018
	 */
	@Select({ "select", "id, his_id, name, image_url, img_url, url, brief, dept_doctor_url, out_service, ",
			"admin_expert_id, is_displayed, name_en, intro", "from xpw_dept", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update xpw_dept", "set his_id = #{hisId,jdbcType=INTEGER},", "name = #{name,jdbcType=VARCHAR},",
			"image_url = #{imageUrl,jdbcType=VARCHAR},", "img_url = #{imgUrl,jdbcType=VARCHAR},",
			...
			"name_en = #{nameEn,jdbcType=VARCHAR},", "intro = #{intro,jdbcType=LONGVARCHAR}",
	...
	@Update({ "update xpw_dept", "set his_id = #{hisId,jdbcType=INTEGER},", "name = #{name,jdbcType=VARCHAR},",
			...
			"dept_doctor_url = #{deptDoctorUrl,jdbcType=VARCHAR},", "out_service = #{outService,jdbcType=TINYINT},",
			"admin_expert_id = #{adminExpertId,jdbcType=BIGINT},", "is_displayed = #{isDisplayed,jdbcType=TINYINT},",
			"name_en = #{nameEn,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
