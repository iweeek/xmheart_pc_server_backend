...
public interface XPWUserMapper {
     ...
     * @mbg.generated  Sat Nov 11 10:13:20 CST 2017
     */
    @Insert({ "insert into xpw_user (username, password, ", "user_type, role_id, ", "captcha)",
            "values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
            "#{userType,jdbcType=TINYINT}, #{roleId,jdbcType=BIGINT}, ", "#{captcha,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Sat Nov 11 10:13:20 CST 2017
     */
    @Select({ "select", "id, username, password, user_type, role_id, captcha", "from xpw_user",
    ...
    @Update({ "update xpw_user", "set username = #{username,jdbcType=VARCHAR},",
            ...
            "role_id = #{roleId,jdbcType=BIGINT},", "captcha = #{captcha,jdbcType=VARCHAR}",
            "where id = #{id,jdbcType=BIGINT}" })
