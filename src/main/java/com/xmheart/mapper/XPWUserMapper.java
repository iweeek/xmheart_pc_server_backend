...
public interface XPWUserMapper {
     ...
     * @mbg.generated  Sat Jan 27 17:07:32 CST 2018
     */
    @Insert({ "insert into xpw_user (username, password, ", "salt, user_type, ", "role_ids, is_enabled)",
            "values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
            "#{salt,jdbcType=VARCHAR}, #{userType,jdbcType=TINYINT}, ",
            "#{roleIds,jdbcType=VARCHAR}, #{isEnabled,jdbcType=TINYINT})" })
     ...
     * @mbg.generated  Sat Jan 27 17:07:32 CST 2018
     */
    @Select({ "select", "id, username, password, salt, user_type, role_ids, is_enabled", "from xpw_user",
    ...
    @Update({ "update xpw_user", "set username = #{username,jdbcType=VARCHAR},",
            ...
            "is_enabled = #{isEnabled,jdbcType=TINYINT}", "where id = #{id,jdbcType=BIGINT}" })
    int updateByPrimaryKey(XPWUser record);

    @Select({ "select u.id, u.username, u.`password`, u.user_type, u.is_enabled, u.role_ids, r.name as role_name \n" + 
            "from xpw_user as u \n" + 
