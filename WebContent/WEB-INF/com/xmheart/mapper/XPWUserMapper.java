...
public interface XPWUserMapper {
     ...
     * @mbg.generated  Fri Jan 05 20:33:21 CST 2018
     */
    @Insert({ "insert into xpw_user (username, password, ", "salt, user_type, ", "role_id)",
            "values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
            "#{salt,jdbcType=VARCHAR}, #{userType,jdbcType=TINYINT}, ", "#{roleId,jdbcType=BIGINT})" })
     ...
     * @mbg.generated  Fri Jan 05 20:33:21 CST 2018
     */
    @Select({ "select", "id, username, password, salt, user_type, role_id", "from xpw_user",
    ...
    @Update({ "update xpw_user", "set username = #{username,jdbcType=VARCHAR},",
            ...
            "user_type = #{userType,jdbcType=TINYINT},", "role_id = #{roleId,jdbcType=BIGINT}",
            "where id = #{id,jdbcType=BIGINT}" })
